...
const ManageAllOrders = () => {
                      ...
                      <ul role="list" className="-my-6 divide-y divide-gray-200">
                        {
                          orders.map(order => (
                            <span>
                              ...
                              {
                                order.statue==null &&  <li className="py-6 flex">
                          ...
                          <div className="ml-4 flex-1 flex flex-col">
                            <div>
                              <div className="flex justify-between text-base font-medium text-gray-900">
                                ...
                                <span className="hidden">{subTotal+=order.details.price}</span>
                              </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                            ...
                            <div className="flex-1 font-medium flex items-end justify-between text-sm">
                              ...
                              {order.address && <p className="text-gray-500 font-mono">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                ...
                <div className="border-t border-gray-200 py-6 px-4 sm:px-6">
                  ...
                  <div className="mt-6">
                    <Link to="/dashboard/payment" className="flex justify-center items-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-green-600 hover:bg-green-700">Checkout</Link>
                  </div>
                  <div className="mt-6 flex justify-center text-sm text-center text-gray-500">
                    <p>
                      or <Link to="/explore"><button type="button" className="text-indigo-600 font-medium hover:text-indigo-500">Continue Shopping<span aria-hidden="true"> →</span></button></Link>
                    </p>
                  </div>
                </div>
              </div>
