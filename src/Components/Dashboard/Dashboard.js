  ...
  const drawer = (
    <div >
      ...
      <div className="text-start pl-4">
        <Link to='/home' className="text-xl text-blue-800 block py-5"><svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 inline pr-1" viewBox="0 0 20 20" fill="currentColor">
  <path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" />
</svg>Home</Link>
        {
          !admin && <div><Link to={`${url}/myOrders`} className="text-xl text-green-800 block pb-5"><svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 inline pr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
