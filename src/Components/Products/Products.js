...
import ExploreProduct from "./Product/ExploreProduct";
    ...
    <div id="" className="">
      <div className="max-w-2xl mx-auto pb-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:ml-0 lg:mr-2">
        ...
        >
          ...
          <span className="text-gray-600 text-3xl">All Boots</span>
        </h1>

        <div className="mt-6 grid grid-cols-1 gap-y-16 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
          
            {products.map((tour) => (
              <ExploreProduct key={tour._id} tour={tour}></ExploreProduct>))
            }
