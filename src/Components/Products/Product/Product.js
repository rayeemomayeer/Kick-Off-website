    ...
    <div className="flex flex-col items-center justify-center max-w-sm mx-auto rounded-2xl">
        ...
        <div className="w-56 -mt-10 overflow-hidden bg-white rounded-lg shadow-lg md:w-64 dark:bg-gray-800">
            ...
            <div className="flex items-center justify-between px-3 py-2 bg-gray-200 dark:bg-gray-700">
                ...
                <Link to={`/boot/${tour?._id}`}><button className="px-2 py-1 text-xs font-semibold text-white uppercase transition-colors duration-200 transform bg-gray-800 rounded hover:bg-gray-700 dark:hover:bg-gray-600 focus:bg-gray-700 dark:focus:bg-gray-600 focus:outline-none">preview</button></Link>
            </div>
        </div>
    </div>
  );
