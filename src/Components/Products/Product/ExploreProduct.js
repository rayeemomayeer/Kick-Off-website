...
const ExploreProduct = (props) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center max-w-sm mx-auto rounded-2xl">
      ...
      <div className="w-4/5 -mt-5 md:-mt-10 overflow-hidden bg-white rounded-lg shadow-lg md:w-64 dark:bg-gray-800">
        <h3 className="py-2 font-bold tracking-wide text-center text-gray-800 uppercase dark:text-white text-base">
