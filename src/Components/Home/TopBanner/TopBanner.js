      ...
      <div className="px-12 mx-auto max-w-7xl">
        <div className="w-full mx-auto text-left md:w-11/12 xl:w-9/12 md:text-center">
          ...
          <div className="mb-4 space-x-0 md:space-x-2 md:mb-8">
            <Link to="/register" className="inline-flex items-center justify-center w-full px-6 py-3 mb-2 text-lg text-white bg-green-400 rounded-2xl hover:bg-green-500 hover:font-bold sm:w-auto sm:mb-0">
              Get Started
