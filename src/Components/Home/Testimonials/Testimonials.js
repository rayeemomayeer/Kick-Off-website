        ...
        <div className="-mx-3 md:flex items-start flex-wrap">
          {
            reviews.map(review => (
              ...
              <div className="w-full flex mb-4 items-center">
                ...
                </div>:<div className="overflow-hidden rounded-full w-10 h-10 bg-gray-50 border border-gray-200">
                  <img src="https://png.pngitem.com/pimgs/s/22-223968_default-profile-picture-circle-hd-png-download.png" alt />
                </div>}
