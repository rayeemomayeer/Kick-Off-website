    ...
    <div className="w-full h-100">
      ...
      <form className="mt-6" onSubmit={handleLoginSubmit}>
        <div>
          ...
          <input type="text" name="name" onBlur={handleOnBlur} id placeholder="Enter Your Name" className="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500 focus:bg-white focus:outline-none" autofocus autoComplete required />
        </div>
        <div className="mt-4">
