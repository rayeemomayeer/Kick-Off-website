  ...
  return (
    <div>
      <div className="bg-white">
        <div className="pt-6">
          <Link to="/home">
            <button className="text-green-700 text-2xl bg-green-200 rounded px-2 ml-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-9 w-9 inline"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
          ...
          */}
                            <label className="-m-0.5 relative p-0.5 rounded-full flex items-center justify-center focus:outline-none ring-gray-400">
                              ...
                              <span
                                aria-hidden="true"
                                className="h-8 w-8 bg-pink-500 border border-black border-opacity-10 rounded-full"
                              />
                            </label>
                            {/*
            Active and Checked: "ring ring-offset-1"
          ...
          */}
                            <label className="-m-0.5 relative p-0.5 rounded-full flex items-center justify-center focus:outline-none ring-gray-900">
                              ...
                              <span
                                aria-hidden="true"
                                className="h-8 w-8 bg-blue-900 border border-black border-opacity-10 rounded-full"
                              />
                            </label>
                          </div>
                        </fieldset>
